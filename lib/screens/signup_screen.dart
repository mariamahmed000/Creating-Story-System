...
import 'package:babmbino/widgets/text_field_input.dart';
...
class _SignupScreenState extends State<SignupScreen> {
  ...
  int _dateTime = DateTime.now().year;
  int age = 0;
  ...
  void _showDatePicker() {
    showDatePicker(
        ...
        .then((value) {
      age = _dateTime - value!.year.toInt();
      print(age);
    });
  }
  ...
  void signUpUser() async {
    ...
    age: age);
    if (age > 16 || age <14){
      res = 'The allowed age is between 14 and 16';
    }
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: const Padding(
                    ...
                    child: Text('Enter your birthdate', style: TextStyle(color: Color(0xff6e6e6e), fontSize: 17),),
                  ),
                ),
              ),
              const SizedBox(
